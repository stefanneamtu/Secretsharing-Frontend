// Comment written by Stefan:
// Library file adapted from https://www.npmjs.com/package/secrets.js-grempe
// It has been slightly modified to work with React
...
function isSetRNG() {
  return config && config.rng && typeof config.rng === "function";
}
...
function hasCryptoRandomBytes() {
  return typeof crypto === "object" && typeof crypto.randomBytes === "function";
}
...
let secrets = {
  ...
  extractShareComponents: function (share) {
    ...
    // Determine the ID length which is letiable and based on the bit count.
  ...
  setRNG: function (rng) {
    let errPrefix = "Random number generator is invalid ",
      errSuffix =
